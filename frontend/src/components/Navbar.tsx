...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 px-2 sm:px-4 lg:px-6 py-2.5 sm:py-3.5">
      <div className="max-w-7xl mx-auto glass flex items-center justify-between px-3 sm:px-5 lg:px-8 py-2.5 sm:py-3 gap-2.5 sm:gap-3 bg-white/10 border-white/20 max-[380px]:flex-col max-[380px]:items-center">
        ...
        <div className="flex items-center justify-center gap-2.5 sm:gap-3 font-medium text-slate-600 ml-auto max-[380px]:w-full max-[380px]:ml-0">
          {user ? (
            <>
              {user.role === 'ADMIN' && (
